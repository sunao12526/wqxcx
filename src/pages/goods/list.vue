...
onLoad(async (options) => {
  activeCategoryId.value = typeof options?.categoryId === 'string' ? options.categoryId : ''
...
<template>
  <view class="page">
    <wd-navbar title="商品列表" left-arrow safe-area-inset-top placeholder fixed :bordered="false" @click-left="goBack" />
